 ...
 * 报修记录数据访问接口
 */
public interface RepairsListDao {
    /**
     * 查询所有报修记录
     * @return 报修记录对象集合
     */
     ...
     * @return 报修记录对象
     */
    public RepairsList findByRepairsList_id2(int repairslist_id);
     ...
     * @return 受影响行数
     */
    public int addRepairsList(RepairsList repairsList);
     ...
     * @return 受影响行数
     */
    public int updateRepairsList(RepairsList repairsList);
