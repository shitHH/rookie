 ...
 *
 * @Author : CD
 * @ClassName ：社区活动数据访问接口
 * @CreateTime 2022/9/10 15:19
 */
public interface ActivityDao {
     ...
     * @return 活动对象
     */
    public List<ActivityVO> findByAtitle(@Param("activity_title") String activity_title);
     ...
     * @return 活动对象
     */
    public List<ActivityVO> findByAddr(@Param("activity_addr") String activity_addr);
     ...
     * @return 受影响行数
     */
    public int deleteActivity (int[] array);
