...
public class Activity {
    ...
    public Activity(int activity_id, String village_vid, String activity_title, String activity_addr, String activity_comp, Date activity_stime, Date activity_dtime, String activity_stat, Timestamp activity_ctime, String activity_content) {
    ...
    public Activity(int activity_id, String village_vid, String activity_title, String activity_addr, String activity_comp, Date activity_stime, Date activity_dtime, String activity_stat, Timestamp activity_ctime) {
        this.activity_id = activity_id;
        this.village_vid = village_vid;
        this.activity_title = activity_title;
        this.activity_addr = activity_addr;
